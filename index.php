...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['send_message'])) {
    ...
    $sql = "INSERT INTO Wiadomosci (Uzytkownik, Temat, Wiadomosc, Data_wyslania) VALUES ('$uzytkownik', '$temat', '$wiadomosc', '$currentDateTime')";
...
<section class="tv-series" id="tv-series">
    <div class="container">
        ...
        <a href="kup_bilet.php" class="btn btn-primary" id="tickets">Zarezerwuj bilet i opłać go na miejscu</a>
        </div>
    </div>
</section>
